...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/24 11:54:56 by ltrinchi          #+#    #+#             */
/*   Updated: 2022/02/25 23:03:51 by ltrinchi         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_burningship(t_coord img, t_scale scale, t_mlx mlx)
{
	t_nb_cmplx		c;
	t_nb_cmplx		z;
	double			temp;
...
int	ft_call_burningship(t_mlx mlx)
{
	...
	while (img.x < WIDTH_WINDOW)
	{
		...
		{
			ft_burningship(img, ft_scale(*mlx.limit), mlx);
			img.y++;
		}
		img.x++;
	}

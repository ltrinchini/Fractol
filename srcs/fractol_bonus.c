...
/*   Updated: 2023/05/02 12:33:58 by ltrinchini       ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
static	void	ft_txt(void)
{
	...
	ft_putstr_fd("+ : increase precision\n", 1);
	ft_putstr_fd("- : decrease precision\n", 1);
	ft_putstr_fd("ESC: Exit\n", 1);
	ft_putstr_fd("1 to 4: Differents colors\n", 1);
	ft_putstr_fd("arrows keyboard: moves\n", 1);
	ft_putstr_fd("mouse wheel: zoom / zoom out\n", 1);
	ft_putstr_fd("SPACE: move julia with the mouse\n", 1);
	ft_putstr_fd("================================\n", 1);
}
